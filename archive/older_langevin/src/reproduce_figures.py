...
def generate_steady_state_histogram_figure():
    """
    ...
    _, _, ed_final_pop = simulate_evolution(
        key=key,
        initial_mean=initial_mean,
        num_iterations=NUM_ITERATIONS,
        population_size=POPULATION_SIZE,
...
def generate_high_dim_steady_state_histogram_figure():
    """
...
def generate_high_dim_ed_figure():
    """
...
FIGURES = {
    ...
    'S1': ('Fig S1: ED vs Full NES', generate_ed_vs_full_nes_figure),
    'S2': ('Fig S2: ED (Multiplicative) vs NES', generate_ed_vs_multiplicative_nes_figure),
    'S3': ('Fig S3: ED (Boltzmann) vs NES', generate_ed_vs_exponential_nes_figure),
    'S4': ('Fig S4: Steady-state histograms', generate_steady_state_histogram_figure),
    'S5': ('Fig S5: High-D ED dynamics', generate_high_dim_ed_figure),
    'S6': ('Fig S6: High-D steady-state histograms', generate_high_dim_steady_state_histogram_figure),
}
